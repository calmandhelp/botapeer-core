...
INSERT INTO users(name, email, password, description, status) values("taro", "taro@taro.com", "$2a$12$GdY.dZn7wjfLnlqURlaacObGfp9.i0UJ7EQaYbNr4AtAuxVi5nY12", "初めまして！園芸初心者ですがこれから頑張って投稿しようと思います。コメントもお気軽にどうぞ！", 1);
INSERT INTO users(name, email, password, description, status) values("jiro", "jiro@jiro.com", "$2a$12$GdY.dZn7wjfLnlqURlaacObGfp9.i0UJ7EQaYbNr4AtAuxVi5nY12", "自宅で野菜を栽培して10年になります。最近畑を購入しました。", 1);
INSERT INTO users(name, email, password, description, status) values("saburo", "saburo@saburo.com", "$2a$12$GdY.dZn7wjfLnlqURlaacObGfp9.i0UJ7EQaYbNr4AtAuxVi5nY12",  "農学部3年生。ゼミでは細菌の研究をしています。植物病理学に関心があります。", 1);
